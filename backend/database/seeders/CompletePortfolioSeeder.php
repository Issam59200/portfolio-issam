...
class CompletePortfolioSeeder extends Seeder
{
    ...
    {
        $shorts = $this->getShortsData();
        
        foreach ($shorts as $shortData) {
            YouTubeVideo::create($shortData);
        }
    }
    ...
    private function getProjectsData()
    {
        return [
            ...
            [
                ...
                'category' => 'desktop',
                'status' => 'completed',
                'stack' => ['C', 'Make', 'GDB', 'Valgrind'],
                'objectives' => ['Maîtriser le langage C', 'Comprendre les algorithmes de tri', 'Optimiser les performances'],
                'technologies_details' => ['Langage C' => 'Programmation système', 'Makefile' => 'Compilation', 'Valgrind' => 'Détection fuites'],
                'challenges' => ['Gestion manuelle de la mémoire', 'Optimisation des performances', 'Éviter les fuites mémoire'],
                'achievements' => ['Tous algorithmes fonctionnels', 'Aucune fuite mémoire', 'Code bien documenté'],
            ...
            [
                ...
                'category' => 'database',
                'status' => 'completed',
                'stack' => ['SQL', 'MySQL', 'phpMyAdmin', 'MCD/MLD'],
                'objectives' => ['Maîtriser la modélisation', 'Écrire requêtes SQL complexes', 'Optimiser performances'],
                'technologies_details' => ['MySQL' => 'SGBD relationnel', 'SQL' => 'Langage de requêtes', 'Modélisation' => 'MCD, MLD, MPD'],
                'challenges' => ['Normalisation des données', 'Optimisation des requêtes', 'Intégrité référentielle'],
                'achievements' => ['Base normalisée (3NF)', 'Requêtes optimisées', 'Documentation complète'],
            ...
            [
                ...
                'category' => 'system',
                'status' => 'completed',
                'stack' => ['C', 'Linux', 'Processus', 'Système UNIX'],
                'objectives' => ['Comprendre processus UNIX', 'Maîtriser appels système', 'Gérer la concurrence'],
                'technologies_details' => ['Appels système' => 'fork, exec, wait, pipe', 'Signaux' => 'SIGINT, SIGTERM', 'Programmation C' => 'Pointeurs, structures'],
                'challenges' => ['Gestion processus zombies', 'Parsing commandes', 'Gestion erreurs système'],
                'achievements' => ['Shell fonctionnel et stable', 'Toutes fonctionnalités implémentées', 'Code robuste'],
            ...
            [
                ...
                'category' => 'web',
                'status' => 'completed',
                'stack' => ['PHP', 'Symfony', 'Doctrine', 'MySQL', 'Twig', 'Bootstrap'],
                'objectives' => ['Maîtriser Symfony', 'Créer application full-stack', 'Gérer relations complexes BDD'],
                'technologies_details' => ['Symfony 6' => 'Framework PHP', 'Doctrine ORM' => 'Mapping objet-relationnel', 'Twig' => 'Moteur templates'],
                'challenges' => ['Gestion locations et retours', 'Calcul frais de retard', 'Système permissions'],
                'achievements' => ['Application complète', 'Interface responsive', 'Panel admin complet', 'Notifications email'],
            ...
            [
                ...
                'category' => 'data',
                'status' => 'completed',
                'stack' => ['Power BI', 'DAX', 'Data Analysis', 'Data Visualization'],
                'objectives' => ['Maîtriser Power BI', 'Créer visualisations pertinentes', 'Découvrir insights'],
                'technologies_details' => ['Power BI Desktop' => 'Outil visualisation', 'DAX' => 'Langage formules', 'Dataset Spotify' => 'Données réelles'],
                'challenges' => ['Nettoyage dataset', 'Choix visualisations pertinentes', 'Optimisation performances'],
                'achievements' => ['15+ visualisations', 'Dashboard interactif', 'Insights intéressants', 'Design Spotify'],
                'thumbnail' => 'storage/projects/dataviz-spotify-75.png',
                'screenshots' => ['storage/projects/dataviz-spotify-76.png', 'storage/projects/dataviz-spotify-77.png', 'storage/projects/dataviz-spotify-78.png', 'storage/projects/dataviz-spotify-79.png', 'storage/projects/dataviz-spotify-80.png'],
            ...
            [
                ...
                'category' => 'desktop',
                'status' => 'completed',
                'stack' => ['C', 'Graphviz', 'Structures de données'],
            ...
            [
                ...
                'category' => 'network',
                'status' => 'completed',
                'stack' => ['C', 'Sockets', 'TCP/IP', 'Multi-threading'],
                'featured' => false,
                'order' => 12
            ]
        ];
    ...
    private function getShortsData()
    {
        $videoIds = [
